...
import { CalendarDays, Dot, FileText, RotateCcwClock, Shield, SquareDashedText, ThumbsDown, ThumbsUp, TrendingUp, UserRound } from "lucide-react"
...
const Page = async ({ params, searchParams } 
    ...
    return (
        <div className="mt-10 flex flex-col lg:grid lg:grid-cols-[2fr_0.8fr] px-0 md:px-8 lg:px-12 gap-6">
            <div className="flex flex-col">
                ...
                {/* Mobile profile statistic view */}
                <div className="grid grid-cols-2 lg:hidden gap-2 mt-2">
                    <Card className="shadow-card-shadow">
                        <CardHeader className="flex flex-row items-center justify-between">
                            <p className="font-jakarta font-semibold text-[12px] md:text-sm lg:text-md">Popular Topics</p>
                            <p className="font-inter text-[8px] lg:text-xs text-muted-foreground font-semibold">Filtered by tag</p>
                        </CardHeader>
                    ...
                    <Card className="shadow-card-shadow">
                        <CardHeader className="flex flex-row items-center justify-between">
                            <p className="font-jakarta font-semibold text-[12px] md:text-sm lg:text-md">Monthly Readers</p>
                            <span className="flex flex-row items-center gap-1 text-primary">
                                <TrendingUp size={16} />

                                <p className="font-inter text-[8px] lg:text-xs font-semibold">
                                    <span>+75.5%</span>
                                </p>
                            </span>
                        </CardHeader>
                        ...
                        <CardContent>
                            {
                            //TODO: Add monthly readers chart
                            /* <ChartContainer
                            config={chartConfig}
                            className="aspect-auto h-62.5 w-full"
                            >
                                <AreaChart data={user.statistic[0].readers ?? 0}>
                    ...
                    <Card className="shadow-card-shadow">
                        <CardHeader className="flex flex-row items-center justify-between">
                            <p className="font-jakarta font-semibold text-[12px] md:text-sm lg:text-md">Popularity</p>
                            
                            <div className="flex flex-row items-center gap-2 text-muted-foreground text-[8px] lg:text-xs">
                                <span className="flex flex-row gap-1">
                                    <ThumbsUp size={16} />
                                    {user.statistic[0].like}
                                </span>

                                <span className="flex flex-row gap-1">
                                    <ThumbsDown size={16} />
                                    {user.statistic[0].dislike}
                                </span>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="shadow-card-shadow">
                        <CardHeader className="flex flex-row items-center justify-between">
                            <p className="font-jakarta font-semibold text-[12px] md:text-sm lg:text-md">Recent Activity</p>
                        </CardHeader>
            ...
            {/* Desktop profile statistic view */}
            <div className="hidden lg:flex flex-col gap-2">
                <Card className="shadow-card-shadow">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <p className="font-jakarta font-semibold text-md">Popular Topics</p>
                        <p className="font-inter text-xs text-muted-foreground font-semibold">Filtered by tag</p>
                    </CardHeader>
                ...
                <Card className="shadow-card-shadow">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <p className="font-jakarta font-semibold text-md">Monthly Readers</p>
                        <span className="flex flex-row items-center gap-1 text-primary">
                            <TrendingUp size={16} />
                ...
                <Card className="shadow-card-shadow">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <p className="font-jakarta font-semibold text-md">Popularity</p>
                ...
                <Card className="shadow-card-shadow">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <p className="font-jakarta font-semibold text-md">Recent Activity</p>
                    </CardHeader>
